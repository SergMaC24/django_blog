...
class Post(models.Model):
    authors = models.ForeignKey(User, related_name='posts', on_delete=models.CASCADE)
...
class Recipe(models.Model):
    ...
    post = models.ForeignKey(Post, related_name='recipe', on_delete=models.SET_NULL, blank=True, null=True)
...
class Comment(models.Model):
    ...
    """ если миграции не получаются - добавь null=True"""
